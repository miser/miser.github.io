...
不知道它的可以查看它的[官方文档](https://github.com/ice-lab/icestark)。

## 沙箱原理

![流程图](/images/icestark-sandbox/icestark.png)
...
上述代码是 icestark 实现 JS 沙箱的核心代码。通过 with + new Function 的形式，为子应用脚本创建沙箱运行环境，并通过 Proxy 代理阻断沙箱内对 window 全局变量的访问和修改。
